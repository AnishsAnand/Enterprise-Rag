...
import { RagWidgetComponent } from '../rag-widget/rag-widget.component'; // ✅ Import the widget
...
@Component({
  ...
  imports: [
    ...
    MatCardModule,
    MatButtonModule,
    RagWidgetComponent, // ✅ Include it in imports
  ],
  template: `
    <mat-card>
      <h2>Admin Dashboard</h2>
      <p><strong>Status:</strong> {{ systemStatus || 'Loading...' }}</p>
      <p><strong>Uptime:</strong> {{ systemUptime || '-' }}</p>
